...
**File:** `oraclelinux/8/repos/rdma-core-63.0-1.0.0-el8-aarch64.repo`
...
**Action Required:** Edit `oraclelinux/8/repos/rdma-core-63.0-1.0.0-el8-aarch64.repo` and replace `<FILL YOUR BASE URL HERE>` with the actual repository URL that contains these packages.
